"""sub5_blend_07 — α-sweep around sub 13 (which used α=0.5).

p_blend = 0.7 * p_sub5 + 0.3 * subject_mean_acc

If sub 13 (α=0.5, NLL=-0.61) beats sub 5 (α=1.0, NLL=-0.65), the optimal
α may also sit between 0.5 and 1.0; this variant probes the MLP-heavy
side. Combined with sub5_blend_03 (α=0.3) and sub 13 (α=0.5) gives a
three-point sweep for parabolic interpolation of α*.
"""
...
BLEND_WEIGHT_SUB5 = 0.7  # tuned weight sweep around sub 13 (0.5)
