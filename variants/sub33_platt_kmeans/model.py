"""sub33_platt_kmeans — same Platt model.py as sub33_label_platt,
paired with a K-MEANS DIVERSITY labeling.py per worked-example §3.6.
...
reveals (k-means-diversity vs random).
"""
