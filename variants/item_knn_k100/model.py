"""item_knn_k100 — Sub 33 at K=100 (extending the K sweep).

Existing K sweep: K=10 (sub 42, -0.61), K=15 (sub 49, -0.60),
K=20 (sub 33, -0.594 winner), K=25 (sub 50, -0.60), K=50 (sub 43, -0.61).
K=100 fills the upper bracket. Hypothesis: NLL keeps degrading
gradually past K=50 as the softmax-weighted neighborhood washes out;
this either confirms K=20 as a sharp local minimum or surfaces a
shallower plateau out at K=100.

Identical to sub 33 in every other hyperparameter.
"""
