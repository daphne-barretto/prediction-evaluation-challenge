"""sub5_blend_03 — α-sweep around sub 13 (which used α=0.5).

p_blend = 0.3 * p_sub5 + 0.7 * subject_mean_acc

If sub 13 (α=0.5, NLL=-0.61) beats sub 5 (α=1.0, NLL=-0.65), the optimal
α may sit further toward the subject-mean prior; this variant probes
that side. Identical artifacts as sub 13; only BLEND_WEIGHT_SUB5 differs.
"""
...
BLEND_WEIGHT_SUB5 = 0.3  # tuned weight sweep around sub 13 (0.5)
